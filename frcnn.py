...
#change path and class numbers
class FRCNN(object):
    _defaults = {
        "model_path"    : 'model_data/voc_weights_resnet.pth', #logs/ epoch27...
        "classes_path"  : 'model_data/voc_classes.txt', #class, add a txt file with licence
        "confidence"    : 0.5,
        "iou"           : 0.3,
        "backbone"      : "resnet50",
        "cuda"          : True,
